...
class Canvas {
  ...
  setSize(width, height) {
    ...
    var optionsChanged = false;  // If true, options changed and we need to resize
    if (width !== undefined) {
    ...
    let recalculateSize = !optionsPassed || optionsChanged;
    ...
    if (recalculateSize || this.frame.style.width != width || this.frame.style.height != height) {
      ...
      //this.options.width = newWidth + 'px';
      //this.options.height = newHeight + 'px';
