...
Graph3d.prototype._dataInitialize = function(rawData) {
  ...
  dg.dataInitialize(rawData, this);
 ...
 * @param {Object} options
 */
Graph3d.prototype.setOptions = function (options, stopAnimation) {
  if (stopAnimation === undefined) {
    stopAnimation = true;
  }
  ...
  // Previously, data was reloaded here
  // TODO: check if we need to reset the data group(s) in some way
