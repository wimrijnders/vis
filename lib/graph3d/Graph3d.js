 ...
 */
DataGroup.prototype.dataInitialize = function (rawData) {
  ...
  if (data[0].hasOwnProperty('filter')) {
    ...
    if (this.dataFilter === undefined) {
      this.dataFilter = new Filter(rawData, colFilter, this);
...
/**
 * TODO: Param 'graph3d' misnomer; rename or find another construct,
 *       also for the deeper calls.
 */
DataGroup.prototype.getDataPoints = function(graph3d, data) {
  if (data === undefined) {
    data = this.dataTable;
  }

  return this._graphHandler.getDataPoints(graph3d, data);
}
...
Graph3d.prototype._dataInitialize = function(rawData) {
  ...
  this.valueMin = dg.valueMin;
  this.valueMax = dg.valueMax;
...
Graph3d.prototype._redrawAxis = function() {
  ...
  var me = this;
  var drawAxisLabel = function(ctx, point3d, text, armAngle) {
    var point2d = me._convert3Dto2D(point3d);
  ...
  if (xLabel.length > 0) {
    ...
    var point = new Point3d(xText, yText, this.zMin);
    drawAxisLabel(ctx, point, xLabel, armAngle);
  }
  ...
  if (yLabel.length > 0) {
    ...
    var point = new Point3d(xText, yText, this.zMin);
    drawAxisLabel(ctx, point, yLabel, armAngle);
  }
